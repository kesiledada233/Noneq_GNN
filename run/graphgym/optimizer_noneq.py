...
from .opti_langevin import LangevinOptimizer
...
def create_optimizer(params):
    ...
    if cfg.optim.optimizer == 'adam':
        ...
        optimizer = optim.SGD(params,
                              ...
                              weight_decay=cfg.optim.weight_decay)
    # elif cfg.optim.optimizer == 'langevin':
    #     optimizer = LangevinOptimizer(
    #         params, lr=cfg.optim.base_lr, beta=cfg.optim.beta,
    #         anneal_factor=cfg.optim.anneal_factor)
    else:
