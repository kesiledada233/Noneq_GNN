...
from graphgym.models.act_noneq import act_dict
from graphgym.models.feature_augment_noneq import Preprocess
from graphgym.models.feature_encoder import (edge_encoder_dict,
                                             node_encoder_dict)
from graphgym.models.head_noneq import head_dict
from graphgym.models.layer_noneq import (BatchNorm1dEdge, BatchNorm1dNode,
...
class GNN(nn.Module):
    ...
    def forward(self, batch):
        ...
        batch = self.post_mp.layer_post_mp(batch)
        h_embed = batch.node_feature.clone()
        pred, label = self.post_mp._apply_index(batch)

        return pred, label, h_embed, batch
